...
summary: "Sarenza a French e-commerce company that specializes in selling shoes and accessories, current web and mobile application has been rewritten and migrated to Salesforce Commerce Cloud (SFCC) and Salesforce PWA Kit."
images:
