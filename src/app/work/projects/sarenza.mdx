...
summary: "The current web and mobile applications, as well as business processes has been rewritten and migrated to Salesforce Commerce Cloud (SFCC) using Salesforce PWA Kit for Sarenza, a French e-commerce company that specializes in selling shoes and accessories."
images:
